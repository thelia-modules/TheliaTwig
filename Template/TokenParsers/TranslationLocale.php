 ...
 */
class TranslationLocale extends \Twig_TokenParser
{
    ...
    public function parse(\Twig_Token $token)
    {
        ...
        $locale = $parser->getExpressionParser()->parseStringExpression();
        $stream->expect(\Twig_Token::BLOCK_END_TYPE);

        return new TranslationLocaleNode(['locale' => $locale], [], $lineno, $this->getTag());
    }
