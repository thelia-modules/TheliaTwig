...
use TheliaTwig\Template\Node\ElseLoop as NodeElseLoop;
 ...
 */
class ElseLoop extends \Twig_TokenParser
{
    ...
    public function parse(\Twig_Token $token)
    {
        ...
        return new NodeElseLoop($body, $parameters, $lineno, $this->getTag());
    }

    public function decideEndLoop(\Twig_Token $token)
    {
        return $token->test(['endelseloop']);
    }
